...
from . import geo_update_request
from .locality_update_request import LocalityUpdateRequest


class Address(LocalityUpdateRequest):
    """
...
class Address7(LocalityUpdateRequest):
    """
    Coarse locality of the service target.
    """
...
class Address8(LocalityUpdateRequest):
    """
    Coarse locality of the service target.
    """
...
class LocationServesUpdateRequest(BaseModel):
    """
    ...
    point: geo_update_request.GeoUpdateRequest | None = None
    """
    WGS 84 coordinates of the service target.
    """
    address: Address | Address7 | Address8 | None = None
    """
    Coarse locality of the service target.
    """
