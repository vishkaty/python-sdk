...
from . import geo_create_request
from .locality_create_request import LocalityCreateRequest


class Address(LocalityCreateRequest):
    """
...
class Address4(LocalityCreateRequest):
    """
    Coarse locality of the service target.
    """
...
class Address5(LocalityCreateRequest):
    """
    Coarse locality of the service target.
    """
...
class LocationServesCreateRequest(BaseModel):
    """
    ...
    point: geo_create_request.GeoCreateRequest | None = None
    """
    WGS 84 coordinates of the service target.
    """
    address: Address | Address4 | Address5 | None = None
    """
    Coarse locality of the service target.
    """
